          ...
          <aside className="w-full lg:w-64 flex-shrink-0 lg:sticky lg:top-28">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
              <div className="p-6 border-b border-slate-100 flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-[#0066A2]/10 flex items-center justify-center flex-shrink-0">
                  <span className="material-symbols-outlined text-[#0066A2] text-2xl">person</span>
                </div>
              ...
              <nav className="p-2 space-y-1">
                <a onClick={(e) => handleScrollTo(e, 'personal-info')} className={`flex items-center gap-3 px-4 py-3 rounded-xl font-semibold transition-all cursor-pointer ${activeTab === 'personal-info' ? 'bg-[#0066A2]/10 text-[#0066A2]' : 'text-slate-600 hover:bg-slate-50'}`}>
                  <span className="material-symbols-outlined">account_circle</span>
                  <span className="text-sm">Hồ sơ cá nhân</span>
                </a>
                
                <a onClick={(e) => handleScrollTo(e, 'addresses')} className={`flex items-center gap-3 px-4 py-3 rounded-xl font-semibold transition-all cursor-pointer ${activeTab === 'addresses' ? 'bg-[#0066A2]/10 text-[#0066A2]' : 'text-slate-600 hover:bg-slate-50'}`}>
                  <span className="material-symbols-outlined">location_on</span>
                  <span className="text-sm">Quản lý địa chỉ</span>
                </a>

                <a onClick={(e) => handleScrollTo(e, 'password')} className={`flex items-center gap-3 px-4 py-3 rounded-xl font-semibold transition-all cursor-pointer ${activeTab === 'password' ? 'bg-[#0066A2]/10 text-[#0066A2]' : 'text-slate-600 hover:bg-slate-50'}`}>
          ...
          <section className="flex-1 w-full space-y-8">
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white focus:ring-2 focus:ring-[#0066A2]/20 focus:border-[#0066A2] transition-all outline-none font-medium" type="text" defaultValue={user.fullName} />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <input className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white focus:ring-2 focus:ring-[#0066A2]/20 focus:border-[#0066A2] transition-all outline-none font-medium" type="tel" defaultValue={user.soDienThoai || ""} />
                  </div>
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-slate-500 uppercase tracking-widest">Ngày sinh</label>
                    <input className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white focus:ring-2 focus:ring-[#0066A2]/20 focus:border-[#0066A2] transition-all outline-none font-medium" type="date" defaultValue={user.ngaySinh || ""} />
                  </div>
                </div>

                <div className="pt-6 border-t border-slate-100">
                  <button type="button" className="w-full md:w-auto px-10 py-3 bg-[#0066A2] text-white font-bold rounded-xl shadow-lg shadow-[#0066A2]/30 hover:bg-[#005587] hover:-translate-y-0.5 transition-all">
                    Lưu thay đổi
                  </button>
                </div>
              </form>
            ...
            <div id="addresses" className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 md:p-8 scroll-mt-28">
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                {addresses.map((addr) => (
                  <div key={addr.id} className={`p-6 rounded-2xl border transition-all ${addr.isDefault || addr.default ? 'bg-blue-50/50 border-[#0066A2]/30 shadow-sm' : 'bg-white border-slate-200 hover:border-slate-300'} flex flex-col justify-between`}>
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        {(addr.isDefault || addr.default) && (
                          <span className="inline-flex mt-3 bg-[#0066A2]/10 text-[#0066A2] px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-widest items-center gap-1">
                      ...
                      <div className="flex flex-col items-end gap-3">
                        <div className="flex items-center gap-3">
                          <button onClick={() => openEditModal(addr)} className="text-sm font-bold text-[#0066A2] hover:underline">Sửa</button>
            ...
            <div id="password" className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 md:p-8 scroll-mt-28">
              ...
              <form className="space-y-6 max-w-2xl">
                <div className="space-y-2">
                  ...
                  <input className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-[#0066A2]/20 focus:border-[#0066A2] transition-all outline-none" placeholder="••••••••" type="password" />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
          ...
          <div className="bg-white relative z-10 w-full max-w-2xl p-8 rounded-2xl shadow-2xl animate-slide-up max-h-[90vh] overflow-y-auto custom-scrollbar">
            <div className="flex justify-between items-center mb-6 pb-4 border-b border-slate-100">
              <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
                <span className="material-symbols-outlined text-[#0066A2]">{editingId ? 'edit_location' : 'add_location'}</span>
            ...
            <form onSubmit={handleSaveAddress} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-5">
                <div className="space-y-2">
                  ...
                  <input required className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-[#0066A2]/20 focus:border-[#0066A2] transition-all outline-none font-medium" type="text" placeholder="VD: Nguyễn Văn A" value={addrForm.fullName} onChange={e => setAddrForm({...addrForm, fullName: e.target.value})} />
                </div>
                <div className="space-y-2">
                  ...
                  <input required className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-[#0066A2]/20 focus:border-[#0066A2] transition-all outline-none font-medium" type="tel" placeholder="VD: 0987654321" value={addrForm.phone} onChange={e => setAddrForm({...addrForm, phone: e.target.value})} />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                <div className="space-y-2">
                  ...
                  <select required className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-[#0066A2]/20 focus:border-[#0066A2] transition-all outline-none font-medium truncate" value={addrForm.province} onChange={e => setAddrForm({...addrForm, province: e.target.value, district: '', ward: ''})}>
                ...
                <div className="space-y-2">
                  ...
                  <select required disabled={!addrForm.province} className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-[#0066A2]/20 focus:border-[#0066A2] transition-all outline-none font-medium disabled:opacity-50 truncate" value={addrForm.district} onChange={e => setAddrForm({...addrForm, district: e.target.value, ward: ''})}>
                ...
                <div className="space-y-2">
                  ...
                  <select required disabled={!addrForm.district} className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-[#0066A2]/20 focus:border-[#0066A2] transition-all outline-none font-medium disabled:opacity-50 truncate" value={addrForm.ward} onChange={e => setAddrForm({...addrForm, ward: e.target.value})}>
              ...
              <div className="space-y-2">
                ...
                <input required className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-[#0066A2]/20 focus:border-[#0066A2] transition-all outline-none font-medium" type="text" placeholder="VD: Số 10, Ngõ 36 Đồng Lễ" value={addrForm.street} onChange={e => setAddrForm({...addrForm, street: e.target.value})} />
              </div>

              {/* Mặc định Checkbox */}
              <label className="flex items-center gap-3 cursor-pointer group mt-4">
                <input type="checkbox" className="w-5 h-5 rounded text-[#0066A2] focus:ring-[#0066A2] border-slate-300" checked={addrForm.isDefault} onChange={e => setAddrForm({...addrForm, isDefault: e.target.checked})} />
              ...
              <div className="pt-6 flex justify-end gap-3 items-center border-t border-slate-100">
                ...
                <button type="submit" className="bg-[#0066A2] text-white px-8 py-3 font-bold rounded-xl hover:bg-[#005587] shadow-lg shadow-[#0066A2]/20 transition-all flex items-center gap-2">
