export default function CategoryShowcase() {
    return (
      <section className="max-w-[1920px] mx-auto px-6 md:px-12 py-24 md:py-32 bg-surface">
        <div className="flex flex-col md:flex-row gap-8 items-end mb-20 relative">
          <div className="md:w-1/2 lg:w-1/3 z-10">
            <h2 className="font-headline text-4xl md:text-5xl italic mb-6">Khám Phá</h2>
          ...
          <div className="absolute right-0 top-0 md:relative md:flex-1 text-right">
            <span className="font-label text-6xl md:text-[10rem] leading-none opacity-5 select-none font-bold">EST. 2026</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-7 group cursor-pointer relative overflow-hidden">
            ...
            <div className="mt-6 flex justify-between items-baseline">
              <h3 className="font-headline text-3xl">Nam</h3>
              <span className="font-label uppercase tracking-widest text-xs border-b border-on-surface">Khám phá ngay</span>
            </div>
          </div>
          ...
          <div className="md:col-span-5 group cursor-pointer relative overflow-hidden mt-12 md:mt-24">
            ...
            <div className="mt-6 flex justify-between items-baseline">
              <h3 className="font-headline text-3xl">Phụ kiện</h3>
              <span className="font-label uppercase tracking-widest text-xs border-b border-on-surface">Xem chi tiết</span>
            </div>
          </div>
          ...
          <div className="md:col-span-6 md:col-start-4 group cursor-pointer relative overflow-hidden -mt-8 md:-mt-32">
            ...
            <div className="mt-6 flex justify-between items-baseline">
              <h3 className="font-headline text-3xl">Nữ</h3>
              <span className="font-label uppercase tracking-widest text-xs border-b border-on-surface">Mua ngay</span>
            </div>
          </div>
        </div>
      </section>
